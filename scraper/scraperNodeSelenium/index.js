...
profile.setPreference('network.proxy.http', 'http://proxyng.arba.gov.ar');
...
/*      await driver.get('http://rori4.github.io/selenium-practice/#/pages/practice/simple-registration');
